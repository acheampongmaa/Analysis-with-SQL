...
/* Left Outer Join. Returns the entire left table
In this case, the employee demographics table is the left
and the employee salary table is the right*/
...
/* Right Outer Join. Returns the entire RIGHT table
In this case, the employee salary table is the right 
and the employee demographics table is the left*/
